...
static Equihash<176,7> Eh176_7;
static Equihash<144,5> Eh144_5;
static Equihash<168,7> Eh168_7;
...
#define EhInitialiseState(n, k, base_state)  \
    if (n == 96 && k == 3) {                 \
        ...
        Eh176_7.InitialiseState(base_state);  \
    } else if (n == 144 && k == 5) {          \
        Eh144_5.InitialiseState(base_state);  \
    } else if (n == 168 && k == 7) {          \
        Eh168_7.InitialiseState(base_state);  \
    } else {                                 \
                    ...
                    const std::function<bool(EhSolverCancelCheck)> cancelled)
{
    if (n == 96 && k == 3) {
        ...
        return Eh176_7.BasicSolve(base_state, validBlock, cancelled);
    } else if (n == 144 && k == 5) {
        return Eh144_5.BasicSolve(base_state, validBlock, cancelled);
    } else if (n == 168 && k == 7) {
        return Eh168_7.BasicSolve(base_state, validBlock, cancelled);
    } else {
        throw std::invalid_argument("Unsupported Equihash parameters");
    }
    return false;
                    ...
                    const std::function<bool(EhSolverCancelCheck)> cancelled)
{
    if (n == 96 && k == 3) {
        ...
        return Eh176_7.OptimisedSolve(base_state, validBlock, cancelled);
    } else if (n == 144 && k == 5) {
        return Eh144_5.OptimisedSolve(base_state, validBlock, cancelled);
    } else if (n == 168 && k == 7) {
        return Eh168_7.OptimisedSolve(base_state, validBlock, cancelled);
    } else {
        throw std::invalid_argument("Unsupported Equihash parameters");
    }
}
...
#define EhIsValidSolution(n, k, base_state, soln, ret)   \
    if (n == 96 && k == 3) {                             \
        ...
        ret = Eh176_7.IsValidSolution(base_state, soln);  \
    } else if (n == 144 && k == 5) {                      \
        ret = Eh144_5.IsValidSolution(base_state, soln);  \
    } else if (n == 168 && k == 7) {                      \
        ret = Eh168_7.IsValidSolution(base_state, soln);  \
    } else {                                             \
        throw std::invalid_argument("Unsupported Equihash parameters"); \
    }
