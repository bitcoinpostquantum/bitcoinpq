...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinpq.org", "www.bitcoinpq.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcoinpq.org]", "www.bitcoinpq.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitcoinpq.org:80", "www.bitcoinpq.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinpq.org]:80", "www.bitcoinpq.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:19940", "127.0.0.1", 19940));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:19940", "127.0.0.1", 19940));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:19940", "::ffff:127.0.0.1", 19940));
    BOOST_CHECK(TestSplitHost("[::]:19940", "::", 19940));
    BOOST_CHECK(TestSplitHost("::19940", "::19940", -1));
    BOOST_CHECK(TestSplitHost(":19940", "", 19940));
    BOOST_CHECK(TestSplitHost("[]:19940", "", 19940));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:19940", "127.0.0.1:19940"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:19940", "[::]:19940"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
