...
* bpq.conf: contains configuration settings for bpqd or bpq-qt
* bpqd.pid: stores the process id of bpqd while running
...
* debug.log: contains debug information and general logging generated by bpqd or bpq-qt
